...
<template>
    <div class="bg-animate flex min-h-screen items-center justify-center p-4 sm:p-6 lg:p-8">
        <div class="w-full max-w-4xl rounded-lg bg-white p-6 shadow-lg">
            <h1 class="mb-6 text-2xl font-bold text-center" v-if="projet.id">Modifier le projet</h1>
            <h1 class="mb-6 text-2xl font-bold text-center" v-else>Créer le Projet</h1>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex flex-col justify-between space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                    ...
                    <button
                        ...
                        type="button"
                        class="w-full rounded-md bg-red-600 px-4 py-2 text-white hover:bg-red-700 sm:w-auto"
                    >
                        Annuler
                    </button>
                </div>
